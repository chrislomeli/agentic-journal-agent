...
from journal_agent.model.session import JournalEvent

logger = logging.getLogger(__name__)


class JournalEventQueue:
    """
    ...
    def __init__(self, maxsize: int = 0) -> None:
        ...
        self._queue: asyncio.Queue[JournalEvent] = asyncio.Queue(maxsize=maxsize)
    ...
    async def put(self, event: JournalEvent) -> None:
        """
    ...
    async def get(self) -> JournalEvent:
        """
